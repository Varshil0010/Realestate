...
namespace WebAPI.Migrations
{
    ...
    public partial class SeedDemoData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            insert into FurnishingTypes(Name)
            select 'Fully'
            ...
            union
            select 'New Delhi','India'
            union
            select 'Bangalore','India'
            ...
            Address2,CityId,FloorNo,TotalFloors,ReadyToMove,Security,Maintenance,EstPossessionOn,Age,Description,PostedOn,PostedBy)
            select 
            1, --Sell Rent
